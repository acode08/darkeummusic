    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-up">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-extrabold">Join DMS Production</h1>
            <p className="text-sm text-white/35">Create your account to start booking</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-bold tracking-[2px] uppercase text-white/30 mb-2">
              Band Name <span className="text-dms-orange">*</span>
            </label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-xs font-bold tracking-[2px] uppercase text-white/30 mb-2">
              Email <span className="text-dms-orange">*</span>
            </label>
            <input
              type="email"
              value={email}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-bold tracking-[2px] uppercase text-white/30 mb-2">
                Password <span className="text-dms-orange">*</span>
              </label>
              <input
                type="password"
                value={password}
            ...
            <div>
              <label className="block text-xs font-bold tracking-[2px] uppercase text-white/30 mb-2">
                Confirm <span className="text-dms-orange">*</span>
              </label>
              <input
                type="password"
                value={confirm}
        ...
        <p className="text-center text-sm text-white/30 mt-6">
          ...
          <Link href="/login" className="text-dms-orange hover:text-dms-orange-light transition-colors font-semibold">
            Sign in
          </Link>
        </p>
      </div>
